...
- Fix a panic on the queue-empty assert in `Device::maintain` when more than one thread polls the same device. By @AdrianEddy in [#9958](https://github.com/gfx-rs/wgpu/pull/9958).
