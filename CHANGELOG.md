...
#### naga
- Fixed atomic load and store operations being incorrectly generated as non-atmoic memory accesses in GLSL and HLSL. By @CldStlkr in [#9242](https://github.com/gfx-rs/wgpu/pull/9242).
