...
- Fix GLSL output for WGSL vector `select` with integer or boolean values on WebGL 2 and older OpenGL. By @arcusbuilds in [#PRNUM](https://github.com/gfx-rs/wgpu/pull/PRNUM).
