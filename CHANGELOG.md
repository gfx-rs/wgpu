...
- Report WGSL binary operator type mismatches as WGSL errors naming both operand types, instead of IR validation errors like `Operation Add can't work with [1] (of type Matrix { .. }) and [4] (of type Vector { .. })`. By @emilk in [#9970](https://github.com/gfx-rs/wgpu/pull/9970).
