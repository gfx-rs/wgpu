...
- Added support for per-vertex attributes in fragment shaders. Currently only WGSL input is supported, and only SPIR-V or WGSL output is supported. By @atlv in [#8821](https://github.com/gfx-rs/wgpu/issues/8821).
