...
- Added `wgt::Features::CORE_FEATURES_AND_LIMITS` that are currently always reported as supported if device is WebGPU compliant as determined by [`wgpu_types::DownlevelCapabilities::is_webgpu_compliant`]. By @sagudev in [#10293](https://github.com/gfx-rs/wgpu/pull/10293).
