...
- Add Metal indirect-command-buffer lowering for fixed-count multi-draw indirect when render state can be safely resumed. By @matthargett in [#3](https://github.com/gfx-rs/wgpu/pull/9640).
