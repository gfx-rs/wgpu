...
- `SurfaceConfiguration` now exposes `desired_swap_chain_size` which was previously hard-coded to 2. By setting it to 1 you can reduce latency. By @emilk & @wumpf in [#4899](https://github.com/gfx-rs/wgpu/pull/4899)
