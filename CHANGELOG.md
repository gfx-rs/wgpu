...
- Correctly emit `primitive_index` for the SPIR-V backend, handling mesh and raytracing shaders, and stop requiring `enable primitive_index;` in `@any_hit` and `@closest_hit` wgsl shaders. By @JMS55 in [#10153](https://github.com/gfx-rs/wgpu/pull/10153).
