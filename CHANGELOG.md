...
- Reject WGSL loads of structs and arrays that contain atomics, which previously caused a panic in the HLSL backend. By @drakeo338 in [#10046](https://github.com/gfx-rs/wgpu/issues/10046).
