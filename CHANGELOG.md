...
- Support `PresentMode::Immediate` on EGL (Linux, Android, ANGLE on Windows) when the driver allows a swap interval of 0. By @Luca00casati in [#XXXXX](https://github.com/gfx-rs/wgpu/pull/XXXXX).
