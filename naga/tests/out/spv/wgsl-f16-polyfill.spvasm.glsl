...
layout(location = 0) in float scalar_f16;
...
layout(location = 0) out float scalar_f16_1;
layout(location = 1) out float scalar_f32_1;
layout(location = 2) out vec2 vec2_f16_1;
layout(location = 3) out vec2 vec2_f32_1;
layout(location = 4) out vec3 vec3_f16_1;
layout(location = 5) out vec3 vec3_f32_1;
layout(location = 6) out vec4 vec4_f16_1;
...
void main()
{
    ...
    _output.scalar_f16 = float16_t(scalar_f16) + float16_t(1.0);
    _output.scalar_f32 = scalar_f32 + 1.0;
    _output.vec2_f16 = f16vec2(vec2_f16) + f16vec2(float16_t(1.0));
    _output.vec2_f32 = vec2_f32 + vec2(1.0);
    _output.vec3_f16 = f16vec3(vec3_f16) + f16vec3(float16_t(1.0));
    _output.vec3_f32 = vec3_f32 + vec3(1.0);
    _output.vec4_f16 = f16vec4(vec4_f16) + f16vec4(float16_t(1.0));
    _output.vec4_f32 = vec4_f32 + vec4(1.0);
    scalar_f16_1 = float(_output.scalar_f16);
    scalar_f32_1 = _output.scalar_f32;
    vec2_f16_1 = vec2(_output.vec2_f16);
    vec2_f32_1 = _output.vec2_f32;
    vec3_f16_1 = vec3(_output.vec3_f16);
    vec3_f32_1 = _output.vec3_f32;
    vec4_f16_1 = vec4(_output.vec4_f16);
...
{
    F16IO _output = F16IO(float16_t(0.0), 0.0, f16vec2(float16_t(0.0)), vec2(0.0), f16vec3(float16_t(0.0)), vec3(0.0), f16vec4(float16_t(0.0)), vec4(0.0));
    F16IO _111 = F16IO(float16_t(scalar_f16), scalar_f32, f16vec2(vec2_f16), vec2_f32, f16vec3(vec3_f16), vec3_f32, f16vec4(vec4_f16), vec4_f32);
...
void main()
{
    ...
    F16IO _output = F16IO(float16_t(0.0), 0.0, f16vec2(float16_t(0.0)), vec2(0.0), f16vec3(float16_t(0.0)), vec3(0.0), f16vec4(float16_t(0.0)), vec4(0.0));
    _input = F16IO(float16_t(scalar_f16), scalar_f32, f16vec2(vec2_f16), vec2_f32, f16vec3(vec3_f16), vec3_f32, f16vec4(vec4_f16), vec4_f32);
...
layout(location = 6) in vec4 vec4_f16;
layout(location = 7) in vec4 vec4_f32;
layout(location = 0) out float _284;
...
{
    F16IO _output = F16IO(float16_t(0.0), 0.0, f16vec2(float16_t(0.0)), vec2(0.0), f16vec3(float16_t(0.0)), vec3(0.0), f16vec4(float16_t(0.0)), vec4(0.0));
    F16IO _295 = F16IO(float16_t(scalar_f16), scalar_f32, f16vec2(vec2_f16), vec2_f32, f16vec3(vec3_f16), vec3_f32, f16vec4(vec4_f16), vec4_f32);
    _output.vec2_f16.x = _295.vec2_f16.y;
    _output.vec2_f16.y = _295.vec2_f16.x;
    scalar_f16_1 = float(_output.scalar_f16);
    scalar_f32_1 = _output.scalar_f32;
    vec2_f16_1 = vec2(_output.vec2_f16);
    vec2_f32_1 = _output.vec2_f32;
