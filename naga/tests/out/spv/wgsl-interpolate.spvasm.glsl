...
layout(location = 1) flat out uint flat_first;
...
void main()
{
    FragmentInput _out = FragmentInput(vec4(0.0), 0u, 0u, 0u, 0.0, vec2(0.0), vec3(0.0), vec3(0.0), vec4(0.0), 0.0, 0.0, 0.0);
    gl_PointSize = 1.0;
...
layout(location = 1) flat in uint flat_first;
