...
fn texture_sample() -> @location(0) vec4<f32> {
    ...
    let _e15 = a;
    a = (_e15 + _e14);
    let _e22 = textureSample(image_2d, sampler_reg, tc, vec2<i32>(3i, 1i));
    let _e23 = a;
    a = (_e23 + _e22);
    let _e27 = textureSampleLevel(image_2d, sampler_reg, tc, 2.3f);
    let _e28 = a;
    a = (_e28 + _e27);
    let _e35 = textureSampleLevel(image_2d, sampler_reg, tc, 2.3f, vec2<i32>(3i, 1i));
    let _e36 = a;
    a = (_e36 + _e35);
    let _e44 = textureSampleBias(image_2d, sampler_reg, tc, 2f, vec2<i32>(3i, 1i));
    let _e45 = a;
    a = (_e45 + _e44);
    let _e50 = textureSample(image_2d_array, sampler_reg, tc, 0u);
    let _e51 = a;
    a = (_e51 + _e50);
    let _e59 = textureSample(image_2d_array, sampler_reg, tc, 0u, vec2<i32>(3i, 1i));
    let _e60 = a;
    a = (_e60 + _e59);
    let _e65 = textureSampleLevel(image_2d_array, sampler_reg, tc, 0u, 2.3f);
    let _e66 = a;
    a = (_e66 + _e65);
    let _e74 = textureSampleLevel(image_2d_array, sampler_reg, tc, 0u, 2.3f, vec2<i32>(3i, 1i));
    let _e75 = a;
    a = (_e75 + _e74);
    let _e84 = textureSampleBias(image_2d_array, sampler_reg, tc, 0u, 2f, vec2<i32>(3i, 1i));
    let _e85 = a;
    a = (_e85 + _e84);
    let _e90 = textureSample(image_2d_array, sampler_reg, tc, 0i);
    let _e91 = a;
    a = (_e91 + _e90);
    let _e99 = textureSample(image_2d_array, sampler_reg, tc, 0i, vec2<i32>(3i, 1i));
    let _e100 = a;
    a = (_e100 + _e99);
    let _e105 = textureSampleLevel(image_2d_array, sampler_reg, tc, 0i, 2.3f);
    let _e106 = a;
    a = (_e106 + _e105);
    let _e114 = textureSampleLevel(image_2d_array, sampler_reg, tc, 0i, 2.3f, vec2<i32>(3i, 1i));
    let _e115 = a;
    a = (_e115 + _e114);
    let _e124 = textureSampleBias(image_2d_array, sampler_reg, tc, 0i, 2f, vec2<i32>(3i, 1i));
    let _e125 = a;
    a = (_e125 + _e124);
    let _e130 = textureSample(image_cube_array, sampler_reg, tc3_, 0u);
    let _e131 = a;
    a = (_e131 + _e130);
    let _e136 = textureSampleLevel(image_cube_array, sampler_reg, tc3_, 0u, 2.3f);
    let _e137 = a;
    a = (_e137 + _e136);
    let _e143 = textureSampleBias(image_cube_array, sampler_reg, tc3_, 0u, 2f);
    let _e144 = a;
    a = (_e144 + _e143);
    let _e149 = textureSample(image_cube_array, sampler_reg, tc3_, 0i);
    let _e150 = a;
    a = (_e150 + _e149);
    let _e155 = textureSampleLevel(image_cube_array, sampler_reg, tc3_, 0i, 2.3f);
    let _e156 = a;
    a = (_e156 + _e155);
    let _e162 = textureSampleBias(image_cube_array, sampler_reg, tc3_, 0i, 2f);
    let _e163 = a;
    a = (_e163 + _e162);
    let _e165 = a;
    return _e165;
