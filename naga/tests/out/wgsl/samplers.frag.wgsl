...
fn testTex1D(coord: f32) {
    ...
    let _e328 = coord_1;
    let _e331 = coord_1;
    let _e334 = textureLoad(tex1D, i32(_e331), 3i);
    c = _e334;
    let _e335 = coord_1;
    let _e339 = coord_1;
    let _e343 = textureLoad(tex1D, i32(_e339), 3i);
    c = _e343;
    return;
}
...
fn testTex1DArray(coord_2: vec2<f32>) {
    ...
    let _e106 = textureLoad(tex1DArray, _e102.x, _e102.y, 3i);
    c_1 = _e106;
    let _e107 = coord_3;
    let _e111 = coord_3;
    let _e112 = vec2<i32>(_e111);
    let _e117 = textureLoad(tex1DArray, _e112.x, _e112.y, 3i);
    c_1 = _e117;
    return;
}
...
fn testTex2D(coord_4: vec2<f32>) {
    ...
    let _e432 = coord_5;
    let _e435 = coord_5;
    let _e438 = textureLoad(tex2D, vec2<i32>(_e435), 3i);
    c_2 = _e438;
    let _e439 = coord_5;
    let _e444 = coord_5;
    let _e449 = textureLoad(tex2D, vec2<i32>(_e444), 3i);
    c_2 = _e449;
    return;
}
...
fn testTex2DArray(coord_8: vec3<f32>) {
    ...
    let _e124 = textureLoad(tex2DArray, _e120.xy, _e120.z, 3i);
    c_3 = _e124;
    let _e125 = coord_9;
    let _e130 = coord_9;
    let _e131 = vec3<i32>(_e130);
    let _e137 = textureLoad(tex2DArray, _e131.xy, _e131.z, 3i);
    c_3 = _e137;
    return;
}
...
fn testTex3D(coord_20: vec3<f32>) {
    ...
    let _e264 = coord_21;
    let _e267 = coord_21;
    let _e270 = textureLoad(tex3D, vec3<i32>(_e267), 3i);
    c_6 = _e270;
    let _e271 = coord_21;
    let _e276 = coord_21;
    let _e281 = textureLoad(tex3D, vec3<i32>(_e276), 3i);
    c_6 = _e281;
    return;
}
