...
int64_t int64_function(int64_t x)
{
    ...
    val = (_expr127 + (_expr125 < 0 ? 0 : 63 - (firstbithigh(_expr125))));
    int64_t _expr129 = val;
    int64_t _expr131 = val;
    val = (_expr131 + countbits(_expr129));
    int64_t _expr133 = val;
    int64_t _expr135 = val;
    val = (_expr135 + min(64u, firstbitlow(_expr133)));
    ...
    int64_t _expr154 = val;
    int64_t _expr156 = val;
    ...
    val = (_expr168 + max(_expr165, _expr166));
    int64_t _expr170 = val;
    int64_t _expr171 = val;
    int64_t _expr173 = val;
    val = (_expr173 + min(_expr170, _expr171));
    int64_t _expr175 = val;
    int64_t _expr177 = val;
    val = (_expr177 + reversebits(_expr175));
    int64_t _expr179 = val;
    int64_t _expr181 = val;
    val = (_expr181 + sign(_expr179));
    int64_t _expr183 = val;
    return _expr183;
}
...
uint64_t uint64_function(uint64_t x_1)
{
    ...
    val_1 = (_expr127 + (63u - firstbithigh(_expr125)));
    uint64_t _expr129 = val_1;
    uint64_t _expr131 = val_1;
    val_1 = (_expr131 + countbits(_expr129));
    uint64_t _expr133 = val_1;
    uint64_t _expr135 = val_1;
    val_1 = (_expr135 + min(64u, firstbitlow(_expr133)));
    ...
    uint64_t _expr154 = val_1;
    uint64_t _expr156 = val_1;
    ...
    val_1 = (_expr168 + max(_expr165, _expr166));
    uint64_t _expr170 = val_1;
    uint64_t _expr171 = val_1;
    uint64_t _expr173 = val_1;
    val_1 = (_expr173 + min(_expr170, _expr171));
    uint64_t _expr175 = val_1;
    uint64_t _expr177 = val_1;
    val_1 = (_expr177 + reversebits(_expr175));
    uint64_t _expr179 = val_1;
    return _expr179;
}
