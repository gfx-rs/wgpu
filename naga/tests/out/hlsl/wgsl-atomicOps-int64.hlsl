...
void cs_main(uint3 id : SV_GroupThreadID, uint3 __local_invocation_id : SV_GroupThreadID)
{
    ...
    uint64_t _e67; InterlockedAdd64(workgroup_atomic_scalar, 1uL, _e67);
    int64_t _e71; InterlockedAdd64(workgroup_atomic_arr[1], 1L, _e71);
    uint64_t _e75; InterlockedAdd64(workgroup_struct.atomic_scalar, 1uL, _e75);
    int64_t _e80; InterlockedAdd64(workgroup_struct.atomic_arr[1], 1L, _e80);
    GroupMemoryBarrierWithGroupSync();
    ...
    uint64_t _e99; InterlockedAdd64(workgroup_atomic_scalar, -1uL, _e99);
    int64_t _e103; InterlockedAdd64(workgroup_atomic_arr[1], -1L, _e103);
    uint64_t _e107; InterlockedAdd64(workgroup_struct.atomic_scalar, -1uL, _e107);
    int64_t _e112; InterlockedAdd64(workgroup_struct.atomic_arr[1], -1L, _e112);
    GroupMemoryBarrierWithGroupSync();
    ...
    InterlockedMax64(workgroup_atomic_scalar, 1uL);
    InterlockedMax64(workgroup_atomic_arr[1], 1L);
    InterlockedMax64(workgroup_struct.atomic_scalar, 1uL);
    InterlockedMax64(workgroup_struct.atomic_arr[1], 1L);
    GroupMemoryBarrierWithGroupSync();
    ...
    InterlockedMin64(workgroup_atomic_scalar, 1uL);
    InterlockedMin64(workgroup_atomic_arr[1], 1L);
    InterlockedMin64(workgroup_struct.atomic_scalar, 1uL);
    InterlockedMin64(workgroup_struct.atomic_arr[1], 1L);
    GroupMemoryBarrierWithGroupSync();
    ...
    uint64_t _e179; InterlockedAnd64(workgroup_atomic_scalar, 1uL, _e179);
    int64_t _e183; InterlockedAnd64(workgroup_atomic_arr[1], 1L, _e183);
    uint64_t _e187; InterlockedAnd64(workgroup_struct.atomic_scalar, 1uL, _e187);
    int64_t _e192; InterlockedAnd64(workgroup_struct.atomic_arr[1], 1L, _e192);
    GroupMemoryBarrierWithGroupSync();
    ...
    uint64_t _e211; InterlockedOr64(workgroup_atomic_scalar, 1uL, _e211);
    int64_t _e215; InterlockedOr64(workgroup_atomic_arr[1], 1L, _e215);
    uint64_t _e219; InterlockedOr64(workgroup_struct.atomic_scalar, 1uL, _e219);
    int64_t _e224; InterlockedOr64(workgroup_struct.atomic_arr[1], 1L, _e224);
    GroupMemoryBarrierWithGroupSync();
    ...
    uint64_t _e243; InterlockedXor64(workgroup_atomic_scalar, 1uL, _e243);
    int64_t _e247; InterlockedXor64(workgroup_atomic_arr[1], 1L, _e247);
    uint64_t _e251; InterlockedXor64(workgroup_struct.atomic_scalar, 1uL, _e251);
    int64_t _e256; InterlockedXor64(workgroup_struct.atomic_arr[1], 1L, _e256);
    ...
    uint64_t _e275; InterlockedExchange64(workgroup_atomic_scalar, 1uL, _e275);
    int64_t _e279; InterlockedExchange64(workgroup_atomic_arr[1], 1L, _e279);
    uint64_t _e283; InterlockedExchange64(workgroup_struct.atomic_scalar, 1uL, _e283);
    int64_t _e288; InterlockedExchange64(workgroup_struct.atomic_arr[1], 1L, _e288);
    return;
}
