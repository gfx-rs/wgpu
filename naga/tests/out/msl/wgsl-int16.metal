...
, threadgroup ushort& shared_val
    ...
    short _e13 = sg_val;
    short _e14 = metal::simd_sum(_e13);
    sg_val = _e14;
    short _e15 = sg_val;
    short _e16 = metal::simd_product(_e15);
    sg_val = _e16;
    short _e17 = sg_val;
    short _e18 = metal::simd_min(_e17);
    sg_val = _e18;
    short _e19 = sg_val;
    short _e20 = metal::simd_max(_e19);
    sg_val = _e20;
    short _e21 = sg_val;
    short _e22 = metal::simd_prefix_exclusive_sum(_e21);
    sg_val = _e22;
    short _e23 = sg_val;
    short _e24 = metal::simd_prefix_inclusive_sum(_e23);
    sg_val = _e24;
    short _e25 = sg_val;
    short _e26 = metal::simd_broadcast_first(_e25);
    sg_val = _e26;
    short _e27 = sg_val;
    short _e29 = metal::simd_broadcast(_e27, 4u);
    sg_val = _e29;
    sg_uval = static_cast<ushort>(subgroup_invocation_id);
    ushort _e32 = sg_uval;
    ushort _e33 = metal::simd_sum(_e32);
    sg_uval = _e33;
    ushort _e34 = sg_uval;
    ushort _e35 = metal::simd_min(_e34);
    sg_uval = _e35;
    ushort _e36 = sg_uval;
    ushort _e37 = metal::simd_max(_e36);
    sg_uval = _e37;
    short _e40 = sg_val;
