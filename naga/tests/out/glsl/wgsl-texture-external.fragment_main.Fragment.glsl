...
layout(binding = 0) uniform highp samplerExternalOES _group_0_binding_0_fs;

layout(std430, binding = 0) readonly buffer NagaExternalTextureParams_block_0Fragment { NagaExternalTextureParams _member; } _group_0_binding_0_fs_params;
...
void main() {
    vec4 _e1 = test(_group_0_binding_0_fs, _group_0_binding_0_fs_params._member);
    _fs2p_location0 = _e1;
    return;
}
