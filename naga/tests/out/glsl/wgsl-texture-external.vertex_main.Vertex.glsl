...
layout(binding = 0) uniform highp samplerExternalOES _group_0_binding_0_vs;

layout(std430, binding = 0) readonly buffer NagaExternalTextureParams_block_0Vertex { NagaExternalTextureParams _member; } _group_0_binding_0_vs_params;
...
void main() {
    vec4 _e1 = test(_group_0_binding_0_vs, _group_0_binding_0_vs_params._member);
    gl_Position = _e1;
    return;
}
