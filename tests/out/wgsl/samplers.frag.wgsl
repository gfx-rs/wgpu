...
fn testTex2D(coord_4: vec2<f32>) {
    ...
    c_2 = _e42;
    let _e50 = coord_5;
    let _e57 = textureSampleGrad(tex2D, samp, _e50, vec2(4.0), vec2(4.0), vec2<i32>(5, 5));
    c_2 = _e57;
    let _e60 = coord_5;
    ...
    let _e233 = textureSampleGrad(tex2D, samp, (_e222.xy / vec2(_e222.z)), vec2(4.0), vec2(4.0), vec2<i32>(5, 5));
    c_2 = _e233;
    let _e234 = coord_5;
    let _e246 = coord_5;
    let _e251 = vec4<f32>(_e246.x, _e246.y, 0.0, 6.0);
    let _e263 = textureSampleGrad(tex2D, samp, (_e251.xyz / vec3(_e251.w)).xy, vec2(4.0), vec2(4.0), vec2<i32>(5, 5));
    c_2 = _e263;
    let _e264 = coord_5;
    let _e270 = coord_5;
    ...
    let _e321 = textureSampleLevel(tex2D, samp, (_e313.xy / vec2(_e313.z)), 3.0, vec2<i32>(5, 5));
    c_2 = _e321;
    let _e322 = coord_5;
    let _e331 = coord_5;
    let _e336 = vec4<f32>(_e331.x, _e331.y, 0.0, 6.0);
    let _e345 = textureSampleLevel(tex2D, samp, (_e336.xyz / vec3(_e336.w)).xy, 3.0, vec2<i32>(5, 5));
    c_2 = _e345;
    let _e346 = coord_5;
    let _e353 = coord_5;
    let _e357 = vec3<f32>(_e353.x, _e353.y, 6.0);
    let _e364 = textureSample(tex2D, samp, (_e357.xy / vec2(_e357.z)), vec2<i32>(5, 5));
    c_2 = _e364;
    let _e365 = coord_5;
    let _e373 = coord_5;
    let _e378 = vec4<f32>(_e373.x, _e373.y, 0.0, 6.0);
    let _e386 = textureSample(tex2D, samp, (_e378.xyz / vec3(_e378.w)).xy, vec2<i32>(5, 5));
    c_2 = _e386;
    let _e387 = coord_5;
    let _e395 = coord_5;
    let _e399 = vec3<f32>(_e395.x, _e395.y, 6.0);
    let _e407 = textureSampleBias(tex2D, samp, (_e399.xy / vec2(_e399.z)), 2.0, vec2<i32>(5, 5));
    c_2 = _e407;
    let _e408 = coord_5;
    let _e417 = coord_5;
    let _e422 = vec4<f32>(_e417.x, _e417.y, 0.0, 6.0);
    let _e431 = textureSampleBias(tex2D, samp, (_e422.xyz / vec3(_e422.w)).xy, 2.0, vec2<i32>(5, 5));
    c_2 = _e431;
    let _e432 = coord_5;
    let _e435 = coord_5;
...
fn testTex2DArray(coord_8: vec3<f32>) {
    ...
    c_3 = _e55;
    let _e63 = coord_9;
    let _e73 = textureSampleGrad(tex2DArray, samp, _e63.xy, i32(_e63.z), vec2(4.0), vec2(4.0), vec2<i32>(5, 5));
    c_3 = _e73;
    let _e76 = coord_9;
...
fn testTex3D(coord_20: vec3<f32>) {
    ...
    let _e88 = textureSample(tex3D, samp, (_e81.xyz / vec3(_e81.w)), vec3<i32>(5, 5, 5));
    c_6 = _e88;
    let _e89 = coord_21;
    let _e98 = coord_21;
    let _e103 = vec4<f32>(_e98.x, _e98.y, _e98.z, 6.0);
    let _e111 = textureSampleBias(tex3D, samp, (_e103.xyz / vec3(_e103.w)), 2.0, vec3<i32>(5, 5, 5));
    c_6 = _e111;
    let _e112 = coord_21;
    let _e119 = coord_21;
    ...
    let _e153 = textureSampleLevel(tex3D, samp, (_e145.xyz / vec3(_e145.w)), 3.0, vec3<i32>(5, 5, 5));
    c_6 = _e153;
    let _e154 = coord_21;
    let _e164 = coord_21;
    ...
    let _e207 = textureSampleGrad(tex3D, samp, (_e196.xyz / vec3(_e196.w)), vec3(4.0), vec3(4.0), vec3<i32>(5, 5, 5));
    c_6 = _e207;
    let _e213 = coord_21;
    let _e218 = textureSampleGrad(tex3D, samp, _e213, vec3(4.0), vec3(4.0));
    c_6 = _e218;
    let _e226 = coord_21;
    let _e233 = textureSampleGrad(tex3D, samp, _e226, vec3(4.0), vec3(4.0), vec3<i32>(5, 5, 5));
    c_6 = _e233;
    let _e236 = coord_21;
