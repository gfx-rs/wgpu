...
fn getDistanceAttenuation(distanceSquare: f32, inverseRangeSquared: f32) -> f32 {
    ...
    let _e44: f32 = distanceSquare_1;
    let _e45: f32 = inverseRangeSquared_1;
    factor = (_e44 * _e45);
    let _e49: f32 = factor;
    let _e50: f32 = factor;
    let _e56: f32 = factor;
...
fn D_GGX(roughness: f32, NoH: f32, h: vec3<f32>) -> f32 {
    ...
    let _e51: f32 = NoH_1;
    let _e52: f32 = roughness_1;
    a = (_e51 * _e52);
    let _e55: f32 = roughness_1;
...
fn V_SmithGGXCorrelated(roughness_2: f32, NoV: f32, NoL: f32) -> f32 {
    ...
    NoV_1 = NoV;
    NoL_1 = NoL;
    let _e46: f32 = roughness_3;
    let _e47: f32 = roughness_3;
    a2_ = (_e46 * _e47);
    let _e50: f32 = NoL_1;
    let _e51: f32 = NoV_1;
    let _e52: f32 = a2_;
...
fn specular(f0_5: vec3<f32>, roughness_4: f32, h_1: vec3<f32>, NoV_2: f32, NoL_2: f32, NoH_2: f32, LoH_2: f32, specularIntensity: f32) -> vec3<f32> {
    ...
    let _e57: f32 = roughness_5;
    let _e58: f32 = NoH_3;
    let _e59: f32 = D_GGX(_e57, _e58, h_1);
    D = _e59;
    let _e64: f32 = roughness_5;
    let _e65: f32 = NoV_3;
    let _e66: f32 = NoL_3;
    ...
    F = _e73;
    let _e75: f32 = specularIntensity_1;
    let _e76: f32 = D;
    let _e78: f32 = V;
    let _e80: vec3<f32> = F;
...
fn Fd_Burley(roughness_6: f32, NoV_4: f32, NoL_4: f32, LoH_4: f32) -> f32 {
    ...
    NoL_5 = NoL_4;
    LoH_5 = LoH_4;
    let _e50: f32 = roughness_7;
    let _e52: f32 = LoH_5;
    let _e54: f32 = LoH_5;
    f90_5 = (0.5 + (((2.0 * _e50) * _e52) * _e54));
    let _e62: f32 = f90_5;
    let _e63: f32 = NoL_5;
    let _e64: f32 = F_Schlick_1(1.0, _e62, _e63);
    lightScatter = _e64;
    let _e70: f32 = f90_5;
    let _e71: f32 = NoV_5;
    let _e72: f32 = F_Schlick_1(1.0, _e70, _e71);
    viewScatter = _e72;
...
fn EnvBRDFApprox(f0_7: vec3<f32>, perceptual_roughness: f32, NoV_6: f32) -> vec3<f32> {
    ...
    NoV_7 = NoV_6;
    let _e62: f32 = perceptual_roughness_1;
...
fn perceptualRoughnessToRoughness(perceptualRoughness: f32) -> f32 {
    ...
    let _e45: f32 = perceptualRoughness_1;
...
fn reinhard(color: vec3<f32>) -> vec3<f32> {
    ...
    color_1 = color;
    let _e42: vec3<f32> = color_1;
    let _e45: vec3<f32> = color_1;
...
fn reinhard_extended(color_2: vec3<f32>, max_white: f32) -> vec3<f32> {
    ...
    let _e44: vec3<f32> = color_3;
    let _e47: vec3<f32> = color_3;
    let _e48: f32 = max_white_1;
    let _e49: f32 = max_white_1;
    numerator = (_e44 * (vec3<f32>(1.0) + (_e47 / vec3<f32>((_e48 * _e49)))));
    let _e56: vec3<f32> = numerator;
    let _e59: vec3<f32> = color_3;
...
fn change_luminance(c_in: vec3<f32>, l_out: f32) -> vec3<f32> {
    ...
    c_in_1 = c_in;
    l_out_1 = l_out;
    let _e45: vec3<f32> = c_in_1;
    let _e46: f32 = luminance(_e45);
    l_in = _e46;
    let _e48: vec3<f32> = c_in_1;
    let _e49: f32 = l_out_1;
    let _e50: f32 = l_in;
...
fn reinhard_luminance(color_4: vec3<f32>) -> vec3<f32> {
    ...
    color_5 = color_4;
    let _e43: vec3<f32> = color_5;
    let _e44: f32 = luminance(_e43);
    l_old = _e44;
    let _e46: f32 = l_old;
    let _e48: f32 = l_old;
    l_new = (_e46 / (1.0 + _e48));
    let _e54: vec3<f32> = color_5;
    let _e55: f32 = l_new;
...
fn reinhard_extended_luminance(color_6: vec3<f32>, max_white_l: f32) -> vec3<f32> {
    ...
    let _e45: vec3<f32> = color_7;
    let _e46: f32 = luminance(_e45);
    l_old_1 = _e46;
    let _e48: f32 = l_old_1;
    let _e50: f32 = l_old_1;
    let _e51: f32 = max_white_l_1;
    let _e52: f32 = max_white_l_1;
    numerator_1 = (_e48 * (1.0 + (_e50 / (_e51 * _e52))));
    let _e58: f32 = numerator_1;
    let _e60: f32 = l_old_1;
    l_new_1 = (_e58 / (1.0 + _e60));
    let _e66: vec3<f32> = color_7;
    let _e67: f32 = l_new_1;
...
fn point_light(light: PointLight, roughness_8: f32, NdotV: f32, N: vec3<f32>, V_1: vec3<f32>, R: vec3<f32>, F0_: vec3<f32>, diffuseColor: vec3<f32>) -> vec3<f32> {
    ...
    let _e56: PointLight = light_1;
    let _e59: vec3<f32> = v_WorldPosition_1;
    ...
    let _e174: vec3<f32> = V_2;
    let _e176: vec3<f32> = L;
    let _e177: vec3<f32> = V_2;
    H = normalize((_e176 + _e177));
    let _e183: vec3<f32> = N_1;
    let _e184: vec3<f32> = L;
    let _e190: vec3<f32> = N_1;
    ...
    let _e238: f32 = roughness_9;
    let _e239: vec3<f32> = H;
    let _e240: f32 = NdotV_1;
    let _e241: f32 = NoL_6;
    let _e242: f32 = NoH_4;
    let _e243: f32 = LoH_6;
    let _e244: f32 = specularIntensity_2;
    ...
    let _e302: vec3<f32> = diffuseColor_1;
    let _e307: f32 = roughness_9;
    let _e308: f32 = NdotV_1;
    let _e309: f32 = NoL_6;
    let _e310: f32 = LoH_6;
    let _e311: f32 = Fd_Burley(_e307, _e308, _e309, _e310);
    diffuse = (_e302 * _e311);
    let _e314: vec3<f32> = diffuse;
    let _e315: vec3<f32> = specular_1;
    let _e317: PointLight = light_1;
...
fn dir_light(light_2: DirectionalLight, roughness_10: f32, NdotV_2: f32, normal: vec3<f32>, view: vec3<f32>, R_2: vec3<f32>, F0_2: vec3<f32>, diffuseColor_2: vec3<f32>) -> vec3<f32> {
    ...
    let _e116: vec3<f32> = diffuseColor_3;
    let _e121: f32 = roughness_11;
    let _e122: f32 = NdotV_3;
    let _e123: f32 = NoL_7;
    let _e124: f32 = LoH_7;
    let _e125: f32 = Fd_Burley(_e121, _e122, _e123, _e124);
    diffuse_1 = (_e116 * _e125);
    let _e138: vec3<f32> = F0_3;
    let _e139: f32 = roughness_11;
    let _e140: vec3<f32> = half_vector;
    let _e141: f32 = NdotV_3;
    let _e142: f32 = NoL_7;
    let _e143: f32 = NoH_5;
    let _e144: f32 = LoH_7;
    let _e145: f32 = specularIntensity_3;
    let _e146: vec3<f32> = specular(_e138, _e139, _e140, _e141, _e142, _e143, _e144, _e145);
    specular_2 = _e146;
    let _e148: vec3<f32> = specular_2;
    let _e149: vec3<f32> = diffuse_1;
    let _e151: DirectionalLight = light_3;
    let _e155: f32 = NoL_7;
...
fn main_1() {
    ...
    let _e40: vec4<f32> = global_3.base_color;
    output_color = _e40;
    let _e42: vec4<f32> = output_color;
    let _e44: vec2<f32> = v_Uv_1;
    ...
    let _e51: f32 = global_5.metallic;
    let _e52: vec4<f32> = metallic_roughness;
    metallic = (_e51 * _e52.z);
    let _e56: f32 = global_4.perceptual_roughness;
    let _e57: vec4<f32> = metallic_roughness;
    perceptual_roughness_2 = (_e56 * _e57.y);
    let _e62: f32 = perceptual_roughness_2;
    let _e63: f32 = perceptualRoughnessToRoughness(_e62);
    roughness_12 = _e63;
    let _e66: vec3<f32> = v_WorldNormal_1;
    N_2 = normalize(_e66);
    let _e69: vec4<f32> = v_WorldTangent_1;
    let _e71: vec4<f32> = v_WorldTangent_1;
    T = normalize(_e71.xyz);
    let _e77: vec3<f32> = N_2;
    let _e78: vec3<f32> = T;
    let _e80: vec4<f32> = v_WorldTangent_1;
    B = (cross(_e77, _e78) * _e80.w);
    let _e85: bool = gl_FrontFacing;
    let _e86: vec3<f32> = N_2;
    let _e87: vec3<f32> = N_2;
    ...
    emissive.y = _e153.y;
    emissive.z = _e153.z;
    let _e160: vec4<f32> = global_1.CameraPos;
    let _e162: vec3<f32> = v_WorldPosition_1;
    let _e165: vec4<f32> = global_1.CameraPos;
    let _e167: vec3<f32> = v_WorldPosition_1;
    V_3 = normalize((_e165.xyz - _e167.xyz));
    let _e174: vec3<f32> = N_2;
    let _e175: vec3<f32> = V_3;
    let _e180: vec3<f32> = N_2;
    let _e181: vec3<f32> = V_3;
    NdotV_4 = max(dot(_e180, _e181), 0.0010000000474974513);
    let _e187: f32 = global_6.reflectance;
    let _e189: f32 = global_6.reflectance;
    ...
    let _e211: vec3<f32> = V_3;
    let _e214: vec3<f32> = V_3;
    let _e216: vec3<f32> = N_2;
    R_4 = reflect(-(_e214), _e216);
    loop {
        let _e224: i32 = i;
        let _e225: vec4<u32> = global_2.NumLights;
        let _e229: i32 = i;
        ...
        }
        {
            ...
            let _e237: i32 = i;
            let _e247: i32 = i;
            let _e249: PointLight = global_2.PointLights[_e247];
            let _e250: f32 = roughness_12;
            let _e251: f32 = NdotV_4;
            let _e252: vec3<f32> = N_2;
            let _e253: vec3<f32> = V_3;
            let _e254: vec3<f32> = R_4;
            let _e255: vec3<f32> = F0_4;
            let _e256: vec3<f32> = diffuseColor_4;
    ...
    loop {
        let _e261: i32 = i_1;
        let _e262: vec4<u32> = global_2.NumLights;
        let _e266: i32 = i_1;
        ...
        }
        {
            ...
            let _e274: i32 = i_1;
            let _e284: i32 = i_1;
            let _e286: DirectionalLight = global_2.DirectionalLights[_e284];
            let _e287: f32 = roughness_12;
            let _e288: f32 = NdotV_4;
            let _e289: vec3<f32> = N_2;
            let _e290: vec3<f32> = V_3;
            let _e291: vec3<f32> = R_4;
            let _e292: vec3<f32> = F0_4;
            let _e293: vec3<f32> = diffuseColor_4;
    ...
    let _e299: vec3<f32> = diffuseColor_4;
    let _e301: f32 = NdotV_4;
    let _e302: vec3<f32> = EnvBRDFApprox(_e299, 1.0, _e301);
    diffuse_ambient = _e302;
    let _e307: vec3<f32> = F0_4;
    let _e308: f32 = perceptual_roughness_2;
    let _e309: f32 = NdotV_4;
    ...
    let _e328: vec4<f32> = global_2.AmbientColor;
