...
fn testImg1D(coord: i32) {
    ...
    size = i32(_e10);
    let _e17 = coord_1;
    textureStore(img1D, _e17, vec4(f32(2)));
    let _e22 = coord_1;
...
fn testImg1DArray(coord_2: vec2<i32>) {
    ...
    c_1 = _e20;
    let _e26 = coord_3;
    textureStore(img1DArray, _e26.x, _e26.y, vec4(f32(2)));
    return;
}
...
fn testImg2D(coord_4: vec2<i32>) {
    ...
    c_2 = _e16;
    let _e22 = coord_5;
    textureStore(img2D, _e22, vec4(f32(2)));
    return;
}
...
fn testImg2DArray(coord_6: vec3<i32>) {
    ...
    c_3 = _e22;
    let _e28 = coord_7;
    textureStore(img2DArray, _e28.xy, _e28.z, vec4(f32(2)));
    return;
}
...
fn testImg3D(coord_8: vec3<i32>) {
    ...
    c_4 = _e16;
    let _e22 = coord_9;
    textureStore(img3D, _e22, vec4(f32(2)));
    return;
}
...
fn testImgWriteOnly(coord_12: vec2<i32>) {
    ...
    let _e18 = coord_13;
    textureStore(imgWriteOnly, _e18, vec4(f32(2)));
    return;
}
