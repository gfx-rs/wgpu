...
fn testTex1DArray(coord_2: vec2<f32>) {
    ...
    coord_3 = coord_2;
    let _e18: vec2<f32> = coord_3;
    let _e22: vec4<f32> = textureSample(tex1DArray, samp, _e18.x, i32(_e18.y));
    c_1 = _e22;
    let _e25: vec2<f32> = coord_3;
    let _e30: vec4<f32> = textureSampleBias(tex1DArray, samp, _e25.x, i32(_e25.y), 2.0);
    c_1 = _e30;
    let _e34: vec2<f32> = coord_3;
    let _e40: vec4<f32> = textureSampleGrad(tex1DArray, samp, _e34.x, i32(_e34.y), 4.0, 4.0);
    c_1 = _e40;
    let _e45: vec2<f32> = coord_3;
    let _e52: vec4<f32> = textureSampleGrad(tex1DArray, samp, _e45.x, i32(_e45.y), 4.0, 4.0, 5);
    c_1 = _e52;
    let _e55: vec2<f32> = coord_3;
    let _e60: vec4<f32> = textureSampleLevel(tex1DArray, samp, _e55.x, i32(_e55.y), 3.0);
    c_1 = _e60;
    let _e64: vec2<f32> = coord_3;
    let _e70: vec4<f32> = textureSampleLevel(tex1DArray, samp, _e64.x, i32(_e64.y), 3.0, 5);
    c_1 = _e70;
    let _e73: vec2<f32> = coord_3;
    let _e78: vec4<f32> = textureSample(tex1DArray, samp, _e73.x, i32(_e73.y), 5);
    c_1 = _e78;
    let _e82: vec2<f32> = coord_3;
    let _e88: vec4<f32> = textureSampleBias(tex1DArray, samp, _e82.x, i32(_e82.y), 2.0, 5);
    c_1 = _e88;
    return;
}
...
fn testTex2D(coord_4: vec2<f32>) {
    ...
    c_2 = _e134;
    let _e135: vec2<f32> = coord_5;
    let _e142: vec2<f32> = coord_5;
    ...
    c_2 = _e153;
    let _e154: vec2<f32> = coord_5;
    let _e162: vec2<f32> = coord_5;
    ...
    c_2 = _e175;
    let _e176: vec2<f32> = coord_5;
    let _e185: vec2<f32> = coord_5;
    ...
    c_2 = _e198;
    let _e199: vec2<f32> = coord_5;
    let _e209: vec2<f32> = coord_5;
    ...
    c_2 = _e253;
    let _e254: vec2<f32> = coord_5;
    let _e260: vec2<f32> = coord_5;
    ...
    c_2 = _e270;
    let _e271: vec2<f32> = coord_5;
    let _e278: vec2<f32> = coord_5;
    ...
    c_2 = _e323;
    let _e324: vec2<f32> = coord_5;
    let _e330: vec2<f32> = coord_5;
    ...
    c_2 = _e340;
    let _e341: vec2<f32> = coord_5;
    let _e348: vec2<f32> = coord_5;
...
fn testTex2DShadow(coord_6: vec2<f32>) {
    ...
    d = _e117;
    let _e118: vec2<f32> = coord_7;
    let _e126: vec2<f32> = coord_7;
    ...
    d = _e140;
    let _e141: vec2<f32> = coord_7;
    let _e151: vec2<f32> = coord_7;
    ...
    d = _e167;
    let _e168: vec2<f32> = coord_7;
    let _e173: vec2<f32> = coord_7;
    ...
    d = _e184;
    let _e185: vec2<f32> = coord_7;
    let _e192: vec2<f32> = coord_7;
    ...
    d = _e205;
    let _e206: vec2<f32> = coord_7;
    let _e212: vec2<f32> = coord_7;
...
fn testTex2DArrayShadow(coord_10: vec3<f32>) {
    ...
    coord_11 = coord_10;
    let _e17: vec3<f32> = coord_11;
    let _e20: vec3<f32> = coord_11;
    ...
    d_1 = _e27;
    let _e28: vec3<f32> = coord_11;
    let _e35: vec3<f32> = coord_11;
    ...
    d_1 = _e46;
    let _e47: vec3<f32> = coord_11;
    let _e56: vec3<f32> = coord_11;
    ...
    d_1 = _e69;
    let _e70: vec3<f32> = coord_11;
    let _e74: vec3<f32> = coord_11;
    ...
    d_1 = _e82;
    let _e83: vec3<f32> = coord_11;
    let _e89: vec3<f32> = coord_11;
    ...
    d_1 = _e99;
    let _e100: vec3<f32> = coord_11;
    let _e105: vec3<f32> = coord_11;
...
fn testTexCubeShadow(coord_14: vec3<f32>) {
    ...
    d_2 = _e68;
    let _e69: vec3<f32> = coord_15;
    let _e74: vec3<f32> = coord_15;
    let _e76: vec4<f32> = vec4<f32>(_e74, 1.0);
